  ...
  return (
    <ContainerWrapper>
      ...
      <div className="min-h-[150px] relative">
        ...
        <div className="bg-white md:h-[200px] sm:mt-[22%] md:mt-[18%] lg:mt-[16%] xl:mt-[13%] md:my-6 p-6 rounded-xl shadow-md flex flex-col md:flex-row items-center justify-between gap-6 relative">
          {/* App Image(s) */}
